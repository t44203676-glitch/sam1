<?php
/**
 * admin/serves/views/runaway_cancellations_view.php
 */
    ...
    <form id="updateRequestForm" enctype="multipart/form-data">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom flex-wrap gap-3 bg-white p-3 rounded shadow-sm">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h4 class="mb-0 text-dark fw-bold">إلغاء بلاغ هروب</h4>
...
render_service_field('اسم صاحب العمل', 'sponsor_name', $request['sponsor_name']);
render_service_field('رقم هوية الكفيل', 'sponsor_id', $request['sponsor_id']);
render_service_field('رقم الصادر', 'service_number', $request['service_number']);
render_service_field('جهة الإصدار', 'emirate', $request['emirate']);
