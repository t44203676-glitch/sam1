<?php
/**
 * admin/serves/views/employee/profession_changes_employee_view.php
 * نسخة مخصصة للموظفين - تغيير المهنة
 */
    ...
    <form id="updateRequestForm" enctype="multipart/form-data">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom flex-wrap gap-3 bg-white p-3 rounded shadow-sm">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h4 class="mb-0 text-dark fw-bold">تغيير المهنة (رؤية الموظف)</h4>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body p-4">
                <div class="row g-3">
                    ...
                    render_employee_restricted_field('رقم الصادر', 'service_number', $request['service_number'] ?? $request['export_number'] ?? '', 'text', [], true);
                    ...
                    // حقول قابلة للتعديل
                    render_employee_restricted_field('اسم الكفيل', 'sponsor_name', $request['sponsor_name']);
                    render_employee_restricted_field('اسم المنشأة', 'establishment_name', $request['establishment_name']);
                    render_employee_restricted_field('رقم هوية الكفيل', 'sponsor_id', $request['sponsor_id']);
                    render_employee_restricted_field('مكتب الجوازات', 'emirate', $request['emirate'], 'text', [
                    ...
                    render_employee_restricted_field('تاريخ آخر تعديل (هجري)', 'hijri_date', $request['hijri_date']);
                    ...
                    <table class="table table-hover align-middle mb-0" id="partners-table">
                        ...
                        <tbody>
                            ...
                            <tr data-id="<?php echo $partner['id']; ?>">
                                <td class="px-4 py-3 fw-bold text-muted small"><?php echo str_pad($count++, 2, '0', STR_PAD_LEFT); ?></td>
