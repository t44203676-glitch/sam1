<?php
/**
 * admin/serves/views/employee/followup_requests_employee_view.php
 * نسخة مخصصة للموظفين - التعقيب
 */
    ...
    <form id="updateRequestForm" enctype="multipart/form-data">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom flex-wrap gap-3 bg-white p-3 rounded shadow-sm">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h4 class="mb-0 text-dark fw-bold">التعقيب (رؤية الموظف)</h4>
...
?>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-primary text-white py-3 border-0">
                <h5 class="mb-0 fs-6"><i class="fas fa-user-check me-2"></i> البيانات الأساسية</h5>
            </div>
            <div class="card-body p-4">
                <div class="row g-3">
                    ...
                    // حقول قابلة للتعديل
                    render_employee_restricted_field('تاريخ الهجري', 'hijri_date', $request['hijri_date'] ?? '');
                    render_employee_restricted_field('تاريخ الإصدار', 'last_modified_date', $request['last_modified_date'] ?? '');
