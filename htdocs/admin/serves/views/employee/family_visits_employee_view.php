<?php
/**
 * admin/serves/views/employee/family_visits_employee_view.php
 * نسخة مخصصة للموظفين - الزيارات العائلية
 */
    ...
    <form id="updateRequestForm" enctype="multipart/form-data">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom flex-wrap gap-3 bg-white p-3 rounded shadow-sm">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h4 class="mb-0 text-dark fw-bold">الزيارات العائلية (رؤية الموظف)</h4>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body p-4">
                <div class="row g-3">
                    ...
                    render_employee_restricted_field('اسم مقدم الطلب (الكفيل)', 'applicant_name', $request['applicant_name'], 'text', true);
                    ...
                    // حقول قابلة للتعديل
                    render_employee_restricted_field('جنسية الكفيل', 'nationality', $request['nationality']);
                    render_employee_restricted_field('عنوان الكفيل / جهة القدوم', 'arrival_place', $request['arrival_place']);
                    render_employee_restricted_field('رقم الخدمة/المعاملة', 'service_number', $request['service_number']);
                    render_employee_restricted_field('رقم القيد', 'record_number', $request['record_number']);
                    render_employee_restricted_field('التاريخ الهجري', 'hijri_date', $request['hijri_date']);
                    render_employee_restricted_field('مكتب الاستقدام', 'emirate', $request['emirate']);
                    ?>
                </div>
            </div>
        </div>
