...
if ($result['success']) {
    ...
    // ✅ يتم تحميل الصفحات من InquiryModule (المجلد الموحد)
    $basePath = __DIR__ . '/../InquiryModule/pages/';
    switch ($type) {
        case 'تصريح زواج':
        ...
        case 'زيارة تجارية':
            ...
            break;
        case 'عمالة':
        case 'تعقيب العمالة': // New case for labor inquiry
            require_once $basePath . 'labor_inquiry_result.php';
            break;
        case 'إلغاء بلاغ هروب':
            // تم النقل إلى المجلد الجديد
        ...
        case 'التعقيب':
            ...
            break;
        case 'تغيير مهنة':
        case 'تعديل مهنة': // New case for change profession
