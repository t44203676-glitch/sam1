...
<main class="container py-5">
    <section id="services">
        ...
        <div class="row" id="services-list">
            ...
            <!-- البطاقات المضافة حديثاً (التعقيب) -->
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card service-card shadow-sm h-100">
                    <div class="card-body text-center p-4 d-flex flex-column">
                        <div class="service-icon">
                        ...
                        <h5 class="card-title mt-3">نموذج التعقيب</h5>
                        <p class="card-text text-muted flex-grow-1">خدمة لتقديم طلبات التعقيب أو الاستعلام عنها.</p>
                        <a href="index.php?page=inquiry" class="btn btn-primary mt-auto">استعلام</a>
                    </div>
                </div>
            </div>
