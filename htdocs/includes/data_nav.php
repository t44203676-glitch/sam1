...
الاستعلام العام عن المعاملات', 'link' => 'pages/eservices/inquiry.php?service=default', 'icon' => 'images/MOI(1).jpg'],
            ...
            [
                ...
                'services' => [
                    ['title' => 'الاستعلام عن طلبات تأشيرة العمل', 'link' => 'pages/eservices/inquiry.php?service=recruitment', 'icon' => 'images/sectors/es.gif'],
                     ['title' => '
الاستعلام عن طلبات العائلية', 'link' => 'pages/eservices/inquiry.php?service=recruitment', 'icon' => 'images/sectors/es.gif'],
            ...
            [
                ...
                'services' => [
                    ['title' => 'الاستعلام عن الجوازات', 'link' => 'pages/eservices/inquiry.php?service=passports', 'icon' => 'images/sectors/passports.gif'],
                    ['title' => 'الاستعلام عن نقل الخدمات (كفالة)', 'link' => 'pages/eservices/inquiry.php?service=labor', 'icon' => 'images/sectors/passports.gif'],
                    ['title' => 'الاستعلام عن تغيير مهنة', 'link' => 'pages/eservices/inquiry.php?service=change_profession', 'icon' => 'images/sectors/passports.gif'],
                ]
            ],
            [
                'id' => 'cat_traffic',
