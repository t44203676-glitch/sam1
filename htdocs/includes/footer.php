...
endforeach; ?>
        ...
        <p class="foot-note nic-footer pull-left"><span>تحميل تطبيق أبشر</span>
            <?php foreach ($footer_data['apps'] as $app): ?>
                <a href="<?php echo $app['link']; ?>" target="_blank">
                    <?php if ($app['img'] === 'images/ios.png'): ?>
                        <svg width="120" height="35" viewBox="0 0 135 40" xmlns="http://www.w3.org/2000/svg" style="display:inline-block; vertical-align:middle;"><rect width="135" height="40" rx="5" fill="black"/><text x="50%" y="55%" dominant-baseline="middle" text-anchor="middle" fill="white" font-size="12">App Store</text></svg>
