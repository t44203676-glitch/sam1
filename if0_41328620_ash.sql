...
-- Generation Time: 27 مارس 2026 الساعة 08:24
-- إصدار الخادم: 11.4.10-MariaDB
-- PHP Version: 7.2.22
USE if0_41328620_ash;
...
(4, '1725478542', '335403928804', 'سمير علي محمد علي محمد', '9685374776', 'تمت الموافقة', 0, 1, NULL, '2026-03-26 14:31:27', '2026-03-26 15:25:46', 0, 'photo_69c54ffb015f4.jpg', '', NULL, NULL, '', '', NULL, NULL, 0, '', '', NULL, 'وزارة الداخلية-الي', '', NULL, NULL, '5886908555', '1447-10-01', '2021-12-03', '90 يوم', 'زيارة سياحية', '7', '45633456346', '2021-12-03', NULL);
...
DROP TABLE IF EXISTS `civil_affairs_requests`;
...
DROP TABLE IF EXISTS `followup_requests`;
...
DROP TABLE IF EXISTS `labor_inquiry`;
...
DROP TABLE IF EXISTS `marriage_permits`;
...
(11, '8376206535', '0873764058', 'زواج سعودي من اجنبية مواليد السعودية', 'عادل بن عبدالرحمن بن راشد بن صفيان', '1030135758', 'تمت الموافقة', 0, 18, NULL, '2026-03-26 01:01:11', '2026-03-26 11:15:10', 0, '0528848668', '', 'إمارة منطقة الرياض', '1447-10-08', '1030135758', '', 'وزارة الداخلية-الي', 0, '', NULL, '', '', NULL);
...
DROP TABLE IF EXISTS `profession_changes`;
...
DROP TABLE IF EXISTS `related_data`;
...
(53, 'رحاب عبدالعال محمد حسن', NULL, 'A37559209', NULL, NULL, 'زوجة مواطن', 'مصر', 'القاهرة', NULL, 11, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-26 01:04:37', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'تمت الموافقة', 'زواج سعودي من اجنبية مواليد السعودية', NULL),
...
DROP TABLE IF EXISTS `runaway_cancellations`;
...
(1, 'root@admin.com', 'root123', 'Root', NULL, 1, 0, '2026-03-18 21:42:40', 31, '2026-03-27 05:00:29', '46.35.80.6'),
...
(14, 'ابو سلمان ', 'abusalman412', 'Admin', NULL, 1, 0, '2026-03-25 21:35:50', 11, '2026-03-26 12:45:51', '185.80.46.228'),
...
(19, 'محمد ', '9900@#', 'مدير', NULL, 14, 0, '2026-03-26 17:07:07', 1, '2026-03-26 11:54:47', '46.35.81.59'),
...
DROP TABLE IF EXISTS `tourism_visits`;
