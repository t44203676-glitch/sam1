...
@media (max-width: 768px) {
    ...
    tr { margin-bottom: 20px !important; border: 2px solid #344861 !important; padding: 10px !important; background: rgba(255,255,255,0.3) !important; }
    td {
        ...
        border-bottom: 1px dashed rgba(52, 72, 97, 0.2) !important;
    }
    td::before {
    ...
    .watermark { font-size: 50px !important; opacity: 0.1 !important; }
}
.header{
    display:flex;
