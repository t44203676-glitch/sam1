...
$visaType = $request['visa_type'] ?? 'Tourism Visit';
...
<body class="min-h-screen bg-gray-100 py-10 flex flex-col items-center justify-center p-4 print:block print:p-0">
    ...
    <div class="bg-white w-full max-w-4xl mx-auto relative text-gray-800 print:w-full print:max-w-none print:p-0 my-4 p-6 shadow-sm"
        ...
        <div class="w-full mb-1">
            <div class="flex justify-between items-center px-4">
                ...
                <div class="w-1/3 text-center no-print">
                ...
                <div class="w-1/3 text-right flex justify-end">
                    <img src="<?php echo $assetsUrl; ?>images/Kingdom_of_Saudi_Arabia_logo_HQ.png"
                        alt="Kingdom of Saudi Arabia" class="h-20 object-contain">
                </div>
            </div>
        </div>
        ...
        <div class="px-4 md:px-8">
            ...
            <div class="flex gap-4 mb-1 flex-row-reverse">
            ...
            <div class="p-3 mb-4 text-center">
                <p class="text-xs font-bold text-red-600 mb-1 arabic-text">
                    ...
                    <?php echo htmlspecialchars($visitor['arrival_place'] ?? $request['arrival_place'] ?? '---'); ?> )،
                    و بياناتها كالآتي
                </p>
    ...
    <script>
        ...
        async function downloadPDF() {
            ...
            try {
                ...
                pdf.save('tourist_visit_' + visaNum + '.pdf');
            } catch (error) {
