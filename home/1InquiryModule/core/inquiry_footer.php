...
?>
    <!-- Footer Component -->
    <footer class="mt-6 w-full flex justify-center">
      <div class="w-full max-w-[<?= $containerWidth ?>] px-4 bg-[#fcfcfc] pb-2 pt-2 border-t border-gray-200">
        
        <!-- Top Footer Content -->
        <div class="flex flex-col md:flex-row items-center print:items-start mb-2 gap-2 relative">
            ...
            <!-- Right: Logo Area -->
            <div class="flex items-center gap-3 order-1 print:order-2 print:mt-12 print:w-full print:justify-start">
               <div class="w-77 h-23 flex items-center justify-center print:w-auto print:h-auto">
                  <img src="<?php echo $assetsUrl; ?>images/ministry_of_interior.jpg" alt="Ministry of Interior" class="w-full h-full object-contain mix-blend-multiply print:max-h-[150px] print:max-w-[450px]">
               </div>
            </div>

            <!-- Center: Links -->
            <div class="flex flex-wrap justify-center gap-x-8 gap-y-1 text-sm font-bold text-[#555555] order-2 flex-grow print:w-full print:mb-2 print:text-center">
        ...
        <div class="text-center text-[15px] text-[#777777] mb-2 px-4 leading-relaxed font-medium">
            ...
            <div class="flex items-center gap-3 order-2 md:order-1 justify-start mt-2">
    ...
    </div> <!-- End #pdf-capture-wrapper -->
    
    <script>
      lucide.createIcons();
    </script>
<?php // ob_end_flush() removed, handled by register_shutdown_function in bootstrap.php ?>
