...
if (!isset($containerWidth)) $containerWidth = "1300px";
...
<head>
    ...
    <style>
      ...
      .font-ge-bold { font-family: 'GE SS Two'; font-weight: 700 !important; }
      .font-ge-medium { font-family: 'GE SS Two'; font-weight: 500 !important; }
      .font-ge-light { font-family: 'GE SS Two'; font-weight: 300 !important; }
      ...
      @media print {
        ...
        html, body {
            ...
            margin: 0 !important;
            padding: 0 !important;
            zoom: 83%; /* مقياس يضمن صفحة واحدة مع الحفاظ على وضوح الخط وكافة البيانات */
        }
        ...
        * {
        ...
        .no-print-btn, #actions-bar, button, #btn-print, .btn-finish, .no-print-print {
            display: none !important;
            visibility: hidden !important;
        }

        /* 5. إظهار كافة الأقسام الرئيسية والحفاظ على مرونتها */
        header, nav, main, footer, .main-nav, .top-links, .breadcrumb {
        ...
        main {
            margin-bottom: 20px !important; /* مسافة بين المحتوى والفوتر */
        }
        ...
        .container, #pdf-capture-wrapper, #printable-area, .w-full, [class*="max-w-"] {
            width: 100% !important;
        ...
        #printable-area, footer, .bg-white.border-2 {
        ...
        #pdf-capture-wrapper {
            display: flex !important;
            flex-direction: column !important;
            min-height: 315mm !important; /* طول متناسق مع الحفاظ على مسافة بيضاء في النهاية */
            padding-bottom: 30mm !important; /* المسافة البيضاء المطلوبة في نهاية الملف */
        }
        ...
        footer .flex-col.items-center, /* الهيدر الأصلي للفوتر */
        footer div[class*="items-center"].relative { /* حاوية البيانات الرئيسية */
            align-items: flex-start !important; /* محاذاة لليمين في RTL */
      ...
      .main-nav {
        ...
        .nav-item.home { background-color: #929292; padding: 8px 15px; }
...
<div id="pdf-capture-wrapper" class="flex flex-col min-h-screen bg-white" dir="rtl">
    ...
    <header class="flex flex-col w-full bg-white">
      ...
      <!-- Branding Section -->
      <div class="w-full max-w-[<?= $containerWidth ?>] mx-auto mt-6 mb-6 flex items-center px-4 print:mt-2 print:mb-2 print:px-0" dir="rtl">
          <!-- Right Side: MOI Logo -->
