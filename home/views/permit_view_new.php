...
if (!array_key_exists($service_type, $table_map)) {
    $service_type = 'marriage_permits'; // Fallback
}
...
if ($id_number && $issue_number) {
    try {
        ...
        if ($permit) {
            ...
            $related_col_name = 'marriage_permit_id'; // Default
            if ($service_type == 'recruitment_requests') $related_col_name = 'recruitment_request_id'; 
            if ($service_type == 'profession_changes') $related_col_name = 'profession_change_id';
